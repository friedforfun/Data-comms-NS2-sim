...
$ns duplex-link $n1(0) $R1 10Mb 10ms DropTail
$ns duplex-link $n1(0) $R3 10Mb 10ms DropTail
$ns duplex-link $n2(0) $R2 10Mb 10ms DropTail
$ns duplex-link $n2(0) $R3 10Mb 10ms DropTail
...
# use the link state routing protocol
$ns rtproto LS
