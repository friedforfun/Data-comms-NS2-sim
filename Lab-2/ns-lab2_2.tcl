...
$ns duplex-link $n3 $n2 2.5Mb 10ms DropTail
...
#Setup a UDP connection 1-3 RED
...
#Setup a UDP connection 3-4 GREEN
...
############--TCP--################
#Setup a TCP connection 0-3 BLUE
...
## Connection TCP 4-0 PURPLE part 2
...
#Setup a FTP over tcp1 connection
...
# node 3-4[cbr] 3.0-4.0, 4.5-6.0, 7.5 -9.0
# node 1-3[cbr1] 0.8-1.5, 2.3-7.2
# node 4-0[ftp1] 0.5-5.0
# node 0-3[ftp] 1.0-8.0
...
$ns at 4.5 "$ns detach-agent $n4 $tcp1 ; $ns detach-agent $n0 $sink1"
